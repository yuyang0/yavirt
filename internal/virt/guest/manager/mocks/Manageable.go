...
func (_m *Manageable) Capture(ctx context.Context, guestID string, user string, name string, overridden bool) (*models.UserImage, error) {
	ret := _m.Called(ctx, guestID, user, name, overridden)

	var r0 *models.UserImage
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string, bool) (*models.UserImage, error)); ok {
		return rf(ctx, guestID, user, name, overridden)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string, bool) *models.UserImage); ok {
...
func (_m *Manageable) Create(ctx context.Context, opts types.GuestCreateOption, host *models.Host, vols []*models.Volume) (*guest.Guest, error) {
	ret := _m.Called(ctx, opts, host, vols)

	var r0 *guest.Guest
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, types.GuestCreateOption, *models.Host, []*models.Volume) (*guest.Guest, error)); ok {
		return rf(ctx, opts, host, vols)
	}
	if rf, ok := ret.Get(0).(func(context.Context, types.GuestCreateOption, *models.Host, []*models.Volume) *guest.Guest); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, types.GuestCreateOption, *models.Host, []*models.Volume) error); ok {
...
func (_m *Manageable) ListImage(ctx context.Context, filter string) ([]models.Image, error) {
...
func (_m *Manageable) ListSnapshot(ctx context.Context, guestID string, volID string) (map[*models.Volume]models.Snapshots, error) {
	ret := _m.Called(ctx, guestID, volID)

	var r0 map[*models.Volume]models.Snapshots
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (map[*models.Volume]models.Snapshots, error)); ok {
		return rf(ctx, guestID, volID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string) map[*models.Volume]models.Snapshots); ok {
