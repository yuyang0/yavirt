...
func (_m *Bot) AmplifyVolume(vol volume.Volume, cap int64, devPath string) error {
	ret := _m.Called(vol, cap, devPath)

	var r0 error
	if rf, ok := ret.Get(0).(func(volume.Volume, int64, string) error); ok {
...
func (_m *Bot) AttachVolume(volmod volume.Volume, devName string) (func(), error) {
	ret := _m.Called(volmod, devName)

	var r0 func()
	var r1 error
	if rf, ok := ret.Get(0).(func(volume.Volume, string) (func(), error)); ok {
		return rf(volmod, devName)
	}
	if rf, ok := ret.Get(0).(func(volume.Volume, string) func()); ok {
	...
	if rf, ok := ret.Get(1).(func(volume.Volume, string) error); ok {
...
func (_m *Bot) Capture(user string, name string) (*image.UserImage, error) {
