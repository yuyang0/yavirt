...
func NewSysImage() *SysImage {
	return &SysImage{Generic: meta.NewGeneric()}
}
...
// GetSize gets image's size
func (img *SysImage) GetSize() int64 {
	return img.Size
}
...
func (img *SysImage) GetDistro() string {
	// return img.Name[:6]
	// TODO: better way to detect os type
	return "ubuntu"
}
